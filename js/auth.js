var auth = {
	...
	access : function(id) {
		...
		if (id >= 2) {
			var inv = $('#invLink');
			var html = '<a href="" class="dropdown-toggle" data-toggle="dropdown">Inventory Management <b class="caret"></b></a><ul class="dropdown-menu"><li><a href="?/inventory/main" id="requests">View Inventory</a></li><li><a href="?/inventory/edit" id="faculty" data-toggle="modal">Add Machine</a></li><li><a href="?/inventory/addComp">Add Components</a></li></ul>';
