...
PROTOTYPE._setWidget = function()
{
	...
	return event && {
		...
		scrollX: event.scrollX || window.pageXOffset || document.documentElement.scrollLeft,
		scrollY: event.scrollY || window.pageYOffset || document.documentElement.scrollTop
	} || {};
}
